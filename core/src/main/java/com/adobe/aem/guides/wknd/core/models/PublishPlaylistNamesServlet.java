...
@Component(service = Servlet.class,
        property = {
                "sling.servlet.paths=/aemascs/components/abbvie-playlist/publish-playlist-names.json",
...
public class PublishPlaylistNamesServlet extends SlingAllMethodsServlet {
        ...
        private static final String AUTHOR_URL="https://author-p63260-e524717.adobeaemcloud.com/aemascs/components/abbvie-playlist/playlist-names.json";
        ...
        protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) throws IOException {
                ...
                ServletUtils.forwardGetRequest(request, response, AUTHOR_URL);
