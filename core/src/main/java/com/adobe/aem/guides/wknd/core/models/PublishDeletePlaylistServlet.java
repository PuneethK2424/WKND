...
@Component(service = Servlet.class,
        property = {
                ...
                ServletResolverConstants.SLING_SERVLET_SELECTORS + "=publish-delete-playlist",
...
public class PublishDeletePlaylistServlet  extends SlingAllMethodsServlet {
    ...
    private static final String AUTHOR_URL = "https://author-p63260-e524717.adobeaemcloud.com/bin/wknd/abbvie-playlist/delete-playlist.json";
