...
@Component(service = Servlet.class,
        property = {
                "sling.servlet.paths=/bin/send-data-to-author.json",
...
public class PublishAddVideoServlet extends SlingAllMethodsServlet {
    ...
    private static final String AUTHOR_URL = "https://author-p63260-e524717.adobeaemcloud.com/sling/servlet/default/add-video.json";
