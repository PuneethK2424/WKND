...
@Component(service = Servlet.class,
        property = {
                "sling.servlet.paths=/bin/publish-delete-video.json",
...
public class PublishDeleteVideoServlet extends SlingAllMethodsServlet {
    ...
    private static final String AUTHOR_URL = "https://author-p63260-e524717.adobeaemcloud.com/sling/servlet/default/delete-video.json";
