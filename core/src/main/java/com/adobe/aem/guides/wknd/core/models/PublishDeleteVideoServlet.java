...
@Component(service = Servlet.class,
        property = {
                "sling.servlet.paths=/wknd/components/abbvie-playlist/publish-delete-video.json",
...
public class PublishDeleteVideoServlet extends SlingAllMethodsServlet {
    ...
    private static final String AUTHOR_URL = "https://author-p63260-e524717.adobeaemcloud.com/wknd/components/abbvie-playlist/delete-video.json";
