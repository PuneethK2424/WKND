document.addEventListener('DOMContentLoaded', function () {
    ...
    function getPlaylistsApi() {
        return fetch('/libs/granite/csrf/token.json')
            .then(res => res.json())
            .then(csrf => {
                return fetch('/bin/aemascs/abbvie-playlist/playlist-names.json', {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                        'CSRF-Token': csrf.token,
    ...
    function addVideoToPlaylists(payload) {
        fetch('/libs/granite/csrf/token.json')
            .then(res => res.json())
            .then(csrf => {
                fetch('/bin/aemascs/abbvie-playlist/add-video.json', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'CSRF-Token': csrf.token,
    ...
    function createPlaylistApi(payload) {
        fetch('/libs/granite/csrf/token.json')
            .then(res => res.json())
            .then(csrf => {
                fetch('/bin/aemascs/abbvie-playlist/create-playlist.json', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'CSRF-Token': csrf.token,
    ...
    function deletePlaylist(payload) {
        fetch('/libs/granite/csrf/token.json')
            .then(res => res.json())
            .then(csrf => {
                fetch('/bin/aemascs/abbvie-playlist/delete-playlist.json', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'CSRF-Token': csrf.token,
    ...
    function deleteVideo(url, title) {
        ...
        fetch('/libs/granite/csrf/token.json')
            .then(res => res.json())
            .then(csrf => {
                fetch('/bin/aemascs/abbvie-playlist/delete-video.json', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'CSRF-Token': csrf.token,
